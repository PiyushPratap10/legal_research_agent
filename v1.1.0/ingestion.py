...
def ingestion_pipeline():
    ...
    chroma_collection = client.get_or_create_collection("legal-v1.1.0")
    ...
    constitution_vector_store_index.storage_context.persist("./v1.1.0/indexes/constitution/vector/")
    ...
    criminal_vector_store_index.storage_context.persist("./v1.1.0/indexes/criminal/vector/")
    ...
    civil_vector_store_index.storage_context.persist("./v1.1.0/indexes/civil/vector/")
